...
const ProductDetails = () => {
  ...
  const fetchProductDetails = useCallback( async () => {
    ...
    setActiveImage(dataReponse?.data?.productImages[0].secure_url);
  },[params]);
      ...
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
                  ...
                  return (
                    ...
                    >
                      <img
                        ...
                        onMouseEnter={() => handleMouseEnterProduct(image.secure_url)}
                        onClick={() => handleMouseEnterProduct(image.secure_url)}
                        alt=""
                      />
                    </div>
                  );
        ...
        {loading ? (
          <div className="grid gap-1 w-full">
            ...
            <h2 className="text-2xl lg:text-4xl font-medium h-6 lg:h-8  bg-slate-200 animate-pulse w-full">Content</h2>
