...
const Footer = () => {
  return (
    <footer className="bg-neutral-700 text-white py-6">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 text-center md:text-left">
        <div className="flex flex-col items-center md:items-center border-gray-50 md:border-r sm:border-r gap-2 p-6">
        ...
        <div className="flex flex-col items-center md:items-center border-gray-50 md:border-r gap-2 p-6">
          <div className="flex items-center justify-center w-16 h-16 bg-slate-800 rounded-full">
        ...
        <div className="flex flex-col items-center md:items-center gap-2 p-6">
          <div className="flex items-center justify-center w-16 h-16 bg-slate-800 rounded-full">
